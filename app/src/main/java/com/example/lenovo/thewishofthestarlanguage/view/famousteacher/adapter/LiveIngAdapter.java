...
public class LiveIngAdapter extends RecyclerView.Adapter<LiveIngAdapter.Holder> {
    List<LiveDetailsBean.DataBean.ListBean> list;

    public LiveIngAdapter(List<LiveDetailsBean.DataBean.ListBean> list) {
        this.list = list;
    }
    ...
    public void onBindViewHolder(@NonNull Holder holder, int position) {
        final LiveDetailsBean.DataBean.ListBean listBean = list.get(position);
