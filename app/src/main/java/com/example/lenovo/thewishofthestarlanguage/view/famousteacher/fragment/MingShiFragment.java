 ...
 */
public class MingShiFragment extends BaseFragment implements IMasterContract.view {


    private RecyclerView MingShi_recycle;
    ...
    protected void init(View view) {
        MingShi_recycle=view.findViewById(R.id.MingShi_recycle);
        MingShi_recycle.setLayoutManager(new GridLayoutManager(getContext(),2));
    }

    @Override
    protected void loadData() {
        MasterPresenterImp masterPresenterImp = new MasterPresenterImp(this);
        masterPresenterImp.loadMasterBean(3);
    }
    ...
    public void showMasterBean(MasterBean masterBean) {
        ...
        MingShi_recycle.setAdapter(masterAdapter);
    }
