...
public class ExperienceCourseFragment extends BaseFragment implements IMyCollectionContract.IMyCollectionView{
    private LinearLayout experience_course_fragment_nothing;
    ...
    protected void init(View view) {
        experience_course_fragment_nothing = view.findViewById(R.id.experience_course_fragment_nothing);
    }
    ...
    protected void loadData() {
        ...
        myCollectionPresenterImp.loadMyCollectionData(user.getInt("user_id", 0), 2);
    }
