...
public class SubstituteForReturnFragment extends BaseFragment implements IMyOrderContract.MyOrderView {

    private SharedPreferences preferences;
    private MyOrderPresenterImp myOrderPresenterImp;
    private ListView substitute_for_return_list;
    private LinearLayout substitute_for_return_nothing;
    ...
    protected void init(View view) {
        ...
        substitute_for_return_nothing = view.findViewById(R.id.substitute_for_return_nothing);
    }
    ...
    public void showMyOrder(List<MyOrderBean.DataBean.ListBean> list) {
        if (list.size() == 0) {
            substitute_for_return_nothing.setVisibility(View.VISIBLE);
            substitute_for_return_list.setVisibility(View.GONE);
        } else {
            substitute_for_return_nothing.setVisibility(View.GONE);
            substitute_for_return_list.setVisibility(View.VISIBLE);
